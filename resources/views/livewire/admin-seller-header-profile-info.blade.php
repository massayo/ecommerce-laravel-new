				...
				<div class="user-info-dropdown">
					<div class="dropdown">
						...
						>
							...
							<span id="user-name" class="user-name">{{ $admin->name }}</span>
						</a>
						<div
				...
				<div class="user-info-dropdown">
					<div class="dropdown">
						...
						>
							...
							<span class="user-name" id="user-name">{{ $seller->name }}</span>
						</a>
						<div
							class="dropdown-menu dropdown-menu-right dropdown-menu-icon-list"
						>
							...
							<a class="dropdown-item" href="{{ route('seller.logout_handler') }}"
							onclick="event.preventDefault();document.getElementById('sellerLogoutForm').submit()"
								><i class="dw dw-logout"></i> Log Out</a
							>
							
							<form action="{{ route('seller.logout_handler') }}" id="sellerLogoutForm" method="POST">@csrf</form>
						</div>
					</div>
				</div>
				@endif
