					...
					<div class="col-md-6 col-lg-5">
						...
						<div class="register-box bg-white box-shadow border-radius-10">
							<div class="wizard-content">
								<form class="tab-wizard2 wizard-circle wizard" action="{{ route('seller.save-seller') }}" method="POST" id="step_form" >
									@csrf
			...
			>
				<div class="modal-content">
					...
					<div class="modal-footer justify-content-center">
						<a href="{{ route('seller.login') }}" class="btn btn-primary">Done</a>
					</div>
				</div>
			</div>
		</div>
		...
		<script>
			$(document).ready(function(){
				...
				//$('#payment_method_id').find('option').not(':first').remove();
					...
					// AJAX request 
					$.ajax({
						url: '/seller/payment-methods-guest',
						type: 'get',
						dataType: 'json',
